export const academicStress = [
	...
	{
		text: "Hey, kiddo. I know school is not easy as you have imagined but you'll get through it. You've come this far already, there's no point in quitting. Always remember that somebody out there believes in you, especially ME! 😉",
		yesResponse: '',
	},
];
...
export const familyStress = [
	...
	},
	{
		...
		yesResponse:
			"Slowly, gain some courage to approach them and say sorry. Sometimes, all it takes is just one “sorry”. Normally, parents could not stay mad to their child so they're just waiting for you to apologize. If you can, hug them and assure them that you won't do it again.",
	},
	{
